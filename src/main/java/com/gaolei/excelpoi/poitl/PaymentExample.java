...
public class PaymentExample {
    ...
    public void testResumeExample() throws Exception {
        //System.out.println("$$$$$$$$$"+this.getClass().getResource("/templates/word/payment.docx").getPath());
        Configure config = Configure.newBuilder().customPolicy("detail_table", new DetailTablePolicy()).build();

        XWPFTemplate template = XWPFTemplate.compile(this.getClass().getResource("/templates/word/payment.docx").getPath(), config).render(datas);
